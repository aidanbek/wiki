...
- Mark-and-sweep — паузы на трассировку; generational — большинство объектов умирает молодыми (отдельные young/old heaps).
...
- Современные: Java G1/ZGC, Go (concurrent), .NET (workstation/server); профилирование ловит GC pressure (см. memory-leaks, fundamentals/performance/profiling/memory-profiling).
