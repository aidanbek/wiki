...
Иерархическая структура с упорядоченностью: для каждого узла левое поддерево содержит меньшие значения, правое — большие.
...
- Search/insert/delete — O(log n) в среднем, но O(n) в вырожденном случае → нужны балансировки (см. ../avl.md, ../red-black.md).
