...
Паттерны композиции классов и объектов в крупные структуры с сохранением гибкости: как объекты связываются, как строить
иерархии, как изолировать клиентов от сложности. Используют наследование (class patterns) и композицию (object
patterns). Общая тема — упрощение взаимоотношений между сущностями. Ниже — разбор пар, которые легко спутать.
