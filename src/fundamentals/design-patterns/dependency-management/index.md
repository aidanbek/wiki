...
Управление связями между компонентами: от жёстко закодированных зависимостей (`new MySQLRepository()`) к инъекции и
автоматическому разрешению. Плохое управление зависимостями даёт spaghetti code и мешает изменениям и тестированию.

## Паттерны

- **IoC** — принцип инверсии контроля; **DI** — его реализация через инъекцию зависимостей.
- **Service Locator** — реестр, у которого класс сам запрашивает зависимости (в большинстве случаев — антипаттерн).
- **Service Container** — инфраструктура, автоматизирующая DI: wiring и lifecycle.
