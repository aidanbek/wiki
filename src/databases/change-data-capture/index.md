...
- Log-based — чтение transaction log (WAL/binlog/oplog). Эффективно, низкая нагрузка, ловит все изменения включая DELETE.
...
- Initial snapshot + ongoing streaming для полного состояния. Инструменты: Debezium, Maxwell, встроенный logical decoding.
