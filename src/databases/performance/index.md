...
- Сначала запрос/индекс/схема, потом кэш; не кэшировать плохой запрос вслепую (см. [query-analysis](query-optimization/query-analysis/index.md), [indexing](indexing/index.md)).
