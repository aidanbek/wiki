...
- N+1 (см. [n-plus-one](../../n-plus-one/index.md)), неэффективные JOIN-ы, функции на индексируемых колонках в WHERE.
...
- Проверять гипотезы через EXPLAIN ANALYZE, затем индекс/переписывание запроса (см. [execution-plan](../execution-plan/index.md)).
