...
- От паттернов доступа и требований к консистентности (см. [cap-theorem](theory/cap-theorem/index.md), [oltp-vs-olap](data-modeling/oltp-vs-olap/index.md)), а не от моды.
