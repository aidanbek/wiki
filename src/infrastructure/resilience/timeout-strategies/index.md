...
- Cascading timeouts: вышестоящий таймаут должен быть больше нижестоящего, иначе клиент отвалится раньше, чем сервер
  успеет.
- В современных системах используют deadline/context (gRPC, Go context): срок жизни запроса пробрасывается по всей
  цепочке.
